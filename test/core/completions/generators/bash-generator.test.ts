...
describe('BashGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid bash completion script with header', () => {
      ...
      expect(script).toContain('# Bash completion script for opence CLI');
      expect(script).toContain('_opence_completion() {');
    ...
    it('should generate script that ends with complete registration', () => {
      ...
      expect(script.trim().endsWith('complete -F _opence_completion opence')).toBe(true);
    });
    ...
    it('should handle empty command list', () => {
      ...
      expect(script).toContain('_opence_completion() {');
      expect(script).toContain('complete -F _opence_completion opence');
    });

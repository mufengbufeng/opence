...
describe('ZshGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      ...
      expect(script).toContain('#compdef opence');
      expect(script).toContain('# Zsh completion script for opence CLI');
      expect(script).toContain('_opence() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize opence'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_opence_init() {');
      expect(script).toContain('_opence_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_opence_change_show() {');
      expect(script).toContain('_opence_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_opence_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_opence_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_opence_complete_items'");
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_opence_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_opence_spec() {');
      expect(script).toContain('_opence_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_opence_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _opence opence')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_opence_view() {');

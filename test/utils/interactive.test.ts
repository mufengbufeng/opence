...
describe('interactive utilities', () => {
  let originalopenceInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalopenceInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalopenceInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalopenceInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }

 ...
 *
 * @param projectRoot - The root directory of the project (where `opence/` lives)
 ...
 *
 * @example
 * // Creates opence/changes/add-auth/ with default schema
 * await createChange('/path/to/project', 'add-auth')
 *
 * @example
 * // Creates opence/changes/add-auth/ with TDD schema

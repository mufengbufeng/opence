 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/opence/config.json
 */
 ...
 * Uses ~/.config/opence/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'opence');

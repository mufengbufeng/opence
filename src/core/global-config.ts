...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'opence';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'opence';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/opence/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/opence/
 * - Windows fallback: %APPDATA%/opence/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/opence/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/opence/
 * - Windows fallback: %LOCALAPPDATA%/opence/
 */

...
/**
 * Registry of all opence CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env OPENCE_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'change',
    description: 'Manage opence change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage opence specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'config',
    description: 'View and modify global opence configuration',
    flags: [
      {
        name: 'scope',

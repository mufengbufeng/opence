...
echo "======================================"
echo "Testing opence Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_OPENCE_NO_COMPLETIONS="${OPENCE_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should attempt to install completions)"
echo "--------------------------------------"
unset CI
unset OPENCE_NO_COMPLETIONS
...
echo "Test 3: OPENCE_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export OPENCE_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_OPENCE_NO_COMPLETIONS" ]; then
  export OPENCE_NO_COMPLETIONS="$ORIGINAL_OPENCE_NO_COMPLETIONS"
else
  unset OPENCE_NO_COMPLETIONS
fi
